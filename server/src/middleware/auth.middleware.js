...
const ROLE_PERMISSIONS = {
  ...
  // Orphan-care specialisation of Project Assistant. Inherits the base
  // Project Assistant permissions via normaliseRole fallback in
  // hasPermission, plus ORPHANS_VIEW_PII for guardian-NIC / contact view.
