...
router.use(protect);
router.post('/', authorize('Admin', 'Manager'), vendorController.createVendorCall);
router.put('/:id', authorize('Admin', 'Manager'), vendorController.updateVendorCall);
router.put('/:id/submissions/:submissionId', authorize('Admin', 'Manager'), vendorController.updateSubmissionStatus);
