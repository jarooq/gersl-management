...
import { enroll, list, regenerateToken, withdraw, stats, unreached } from '../controllers/projectBeneficiary.controller.js';
...
router.get('/projects/:projectId/unreached-beneficiaries', protect, validateId('projectId'), unreached);
