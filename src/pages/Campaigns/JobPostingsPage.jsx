    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-blue-500">
            ...
            <h3 className="text-gray-600 text-sm font-medium mb-1">Total Jobs</h3>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-green-500">
            ...
            <h3 className="text-gray-600 text-sm font-medium mb-1">Open Positions</h3>
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {filteredJobs.length === 0 ? (
            <div className="text-center py-16 px-4">
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-2">No Job Postings Yet</h3>
