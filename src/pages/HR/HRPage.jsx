        ...
        <div className="bg-white rounded-xl shadow-sm border border-ink-100 p-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-ink-600 mt-1">Staff across departments</p>
            </div>
            <div className="text-right">
              <div className="text-xl font-bold text-ink-900">{stats.activeStaff}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-ink-100 p-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-ink-600 mt-1">Current leave requests</p>
            </div>
          </div>
              ...
              return leaveStats.map((item, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-ink-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-bold text-ink-900">{item.count} requests</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-ink-100 p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-ink-600">Avg attendance</div>
            </div>
          </div>
              ...
              (() => {
                ...
                return weeklyAttendanceTrend.days.map((day, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <span className="text-xs font-medium text-ink-600 w-16">{day.day}</span>
                    ...
                    <span className="text-xs text-ink-500 w-12 text-right">{day.count}/{stats.totalStaff}</span>
                  </div>
                ));
              })()
            )}
            ...
            {(() => {
              ...
              return (
                <div className="text-right">
                  ...
                  <div className="text-xs text-ink-600">Overall Score</div>
                </div>
              );
            })()}
          </div>
